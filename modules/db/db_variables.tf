...
variable "first_tfe_subnet" {
  description = "First tfe subnet, passed among the modules"
}

variable "second_tfe_subnet" {
  description = "Second tfe subnet, passed among the modules"
}
